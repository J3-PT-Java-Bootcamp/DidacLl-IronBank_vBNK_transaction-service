...
public interface TransactionService {
    ...
    TransferResponse receiveBlindTransfer(TransferRequest request);
...
//    TransactionDTO createTransaction(DataTransferResponse request);
    ...
    ResponseEntity<TransferResponse> initiateTransferRequest(TransferRequest request, Authentication authentication) throws ServiceUnavailableException;
